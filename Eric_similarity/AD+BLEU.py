...
class ObjectSimilarityAdvancedBLEU:
    ...
    def calculate_similarity(self, obj1, obj2):
        ...
        if shared_required:
            weight_per_attr = 0.5 / len(shared_required)  # Dynamic distribution of 0.5 weight
        ...
        if shared_optional:
            weight_per_attr = 0.5 / len(shared_optional)  # Dynamic distribution of 0.5 weight
...
if __name__ == "__main__":
    ...
    similarity_calculator = ObjectSimilarityAdvancedBLEU(attribute_definitions, value_types)
